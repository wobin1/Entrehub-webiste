...
export default function VideoSection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-blue-50/30 via-white to-gray-50/50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200 hover:shadow-3xl transition-all duration-500">
          {/* Video Area */}
          <div
            className="relative aspect-[16/9] bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 cursor-pointer group"
            onMouseEnter={() => setShowControls(true)}
            onMouseLeave={() => setShowControls(false)}
            onClick={togglePlay}
          >
            {/* Enhanced Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900/60 via-gray-900/80 to-blue-800/90"></div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <button
                onClick={togglePlay}
                className={`w-24 h-24 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-2xl group/play ${isPlaying ? 'opacity-0' : 'opacity-100'
                  }`}
              >
          ...
          <div className="p-8 bg-gradient-to-r from-white via-blue-50/20 to-orange-50/20">
            <div className="flex items-start justify-between">
              ...
              <div className="ml-8 flex-shrink-0">
                <div className="text-center bg-gradient-to-r from-blue-50 to-orange-50 rounded-2xl p-6 border border-gray-200">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-4 bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
            <span className="text-lg text-gray-600">Ready to transform your brand?</span>
